...
DEFAULT_OUT_MODEL = "ASQP_MA/aspect_lr_baseline.joblib"
...
class AspectLRBaseline:
    ...
    @staticmethod
    def load(path: str) -> "AspectLRBaseline":
        payload = joblib.load(path)
        return AspectLRBaseline(
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a minimal LR baseline for aspect prediction.")
