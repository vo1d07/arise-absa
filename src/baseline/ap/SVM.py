...
DEFAULT_OUT_MODEL = "ASQP_MA/tfidf_svm_a_ipv_baseline.joblib"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a minimal SVM baseline for AIPV aspect prediction.")
