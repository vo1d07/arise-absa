...
# OpenAI grid search for A-IPV.
#
# Usage example:
#   bash grid_search_openai_aipv.sh \
#     --in_csv datasets/dataset.csv \
#     --out_dir outputs/grid_search_openai_aipv \
#     --runs 1 \
...
echo "A-IPV grid search started"
