...
# OpenAI grid search for S-IPV.
#
# Usage example:
#   bash grid_search_openai_sipv.sh \
#     --in_csv outputs/baseline_test_seed42_sipv.csv \
#     --out_dir outputs/grid_search_openai_sipv \
#     --runs 1 \
...
echo "S-IPV grid search started"
