...
# Usage:
#   bash run_incremental_contrib_anthropic.sh \
#     --aipv_in_csv datasets/dataset_for_aipv.csv \
#     --sipv_in_csv outputs/AIPV_output.csv \
#     --out_dir outputs/incremental_contrib_anthropic \
#     --runs 1 \
#     --threshold 0.5 \
#     --tau_sent 0.5

# Defaults tuned for Anthropic-based scripts
...
for r in $(seq 1 "$RUNS"); do
  ...
  # A-IPV variants (Anthropic implementation files)
  ...
  # S-IPV groups (Anthropic implementation files)
...
echo "All Anthropic runs completed."
